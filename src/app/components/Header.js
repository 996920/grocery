...
const Header = () => {
  return (
    	...
    	<div className="container">
        	<div className="row ">
                ...
                <div className="head_log_area ml-auto">
                	<ul>
                        <li><a href="#"><img src="images/icon03.png" alt=""/>dhrubadjs.mng@gmail.com</a></li>
                        <li><a href="tel:7797813261"><img src="images/icon02.jpg" alt=""/> +91 7797813261</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div className="middle_head">
    	<div className="container">
        	<div className="row res_padd">
            	<span className="logo"><a href="index.html"><img src="images/logo.png" alt=""/></a></span>
	...
	<div className="adjust_rm01">
		...
		<nav className="off_canvas">
                <ul>
                    <li className="has_levels"><a href="javascript:void(0);" className="adjust_rm02 nav_next_btn">All Categories <i className="fa fa-caret-down" aria-hidden="true"></i></a>
                        <ul className="nav_level_current">                            
                            <li className="has_levels">
                                <a href="javascript:void(0);" className="nav_next_btn">Vegetable <i className="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                            ...
                            <li className="has_levels">
                                <a href="javascript:void(0);" className="nav_next_btn">Fruits<i className="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="javascript:void(0);">Sub Category One</a></li>
                                    <li><a href="javascript:void(0);">Sub Category three</a></li>
                                    <li><a href="javascript:void(0);">Dummy Sub Category name</a></li>
                            ...
                            <li className="has_levels">
                                <a href="javascript:void(0);" className="nav_next_btn">Dairy products <i className="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="javascript:void(0);">Sub Category One</a></li>
                                    <li><a href="javascript:void(0);">Abc Sub Category Here</a></li>
                                    <li><a href="javascript:void(0);">Sub Category three</a></li>
                            ...
                            <li className="has_levels">
                                <a href="javascript:void(0);" className="nav_next_btn">Organic Products <i className="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="javascript:void(0);">Sub Category One</a></li>
                                    <li><a href="javascript:void(0);">Dummy Sub Category name</a></li>
                                    <li><a href="javascript:void(0);">Sub Category One</a></li>
                            ...
                            <li className="has_levels">
                                <a href="javascript:void(0);" className="nav_next_btn">Grocery Items <i className="fa fa-angle-right" aria-hidden="true"></i></a>
                                <ul>
                                    <li><a href="javascript:void(0);">Sub Category One</a></li>
                                    <li><a href="javascript:void(0);">Abc Sub Category Here</a></li>
                                    <li><a href="javascript:void(0);">Sub Category three</a></li>
